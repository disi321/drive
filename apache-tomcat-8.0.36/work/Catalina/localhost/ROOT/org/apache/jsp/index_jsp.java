 ...
 * Generated at: 2022-02-13 18:07:06 UTC
...
return;
    ...
    try {
      ...
      out.write("    <div class=\"flex w-1/2 bg-gradient-to-tr from-blue-800 to-purple-700 i justify-around items-center\">\n");
      out.write("        <div>\n");
      out.write("            <h1 class=\"text-white font-bold text-4xl font-sans\">GoFinance</h1>\n");
      out.write("            <p class=\"text-white mt-1\">The most popular peer to peer lending at SEA</p>\n");
      out.write("            <button type=\"submit\" class=\"block w-28 bg-white text-indigo-800 mt-4 py-2 rounded-2xl font-bold mb-2\">Read More</button>\n");
      out.write("        </div>\n");
      out.write("    </div>\n");
      ...
      out.write("            <h1 class=\"text-gray-800 font-bold text-2xl mb-1\">Hello Again!</h1>\n");
      out.write("            <p class=\"text-sm font-normal text-gray-600 mb-7\">Welcome Back</p>\n");
      ...
      out.write("            </div>\n");
      out.write("            <button type=\"submit\" class=\"block w-full bg-indigo-600 mt-4 py-2 rounded-2xl text-white font-semibold mb-2\">Login</button>\n");
      out.write("            <span class=\"text-sm ml-2 hover:text-blue-500 cursor-pointer\">Forgot Password ?</span>\n");
      out.write("        </form>\n");
      out.write("    </div>\n");
      out.write("</div>\n");
      out.write("</body>\n");
